        ...
        <template slot-scope="props">
          <el-form label-position="left" inline class="demo-table-expand">
            ...
            <el-form-item label="区块链哈希验证：">
              <div>
              <a href="http://43.143.251.211:8080/?tab=transactions&transId=props.row.farmer_input.fa_txid" style="background-color: blue; color: white; padding: 10px 20px; text-decoration: none; border-radius: 5px;”>产品信息验证按钮</a>
              </div>
            </el-form-item>
            ...
            <el-form-item label="区块链哈希验证：">
              <div>
                <a href="http://43.143.251.211:8080/?tab=transactions&transId=props.row.factory_input.fa_txid" style="background-color: blue; color: white; padding: 10px 20px; text-decoration: none; border-radius: 5px;”>工厂信息验证按钮</a>
              </div>
            </el-form-item>
            ...
            <el-form-item label="区块链哈希验证：">
              <div>
                <a href="http://43.143.251.211:8080/?tab=transactions&transId=props.row.driver_input.fa_txid" style="background-color: blue; color: white; padding: 10px 20px; text-decoration: none; border-radius: 5px;”>运输信息验证按钮</a>
              </div>
            </el-form-item>
            ...
            <el-form-item label="区块链哈希验证：">
              <div>
                <a href="http://43.143.251.211:8080/?tab=transactions&transId=props.row.shop_input.fa_txid" style="background-color: blue; color: white; padding: 10px 20px; text-decoration: none; border-radius: 5px;”>销售信息验证按钮</a>
              </div>
            </el-form-item>
          </el-form>
        </template>
